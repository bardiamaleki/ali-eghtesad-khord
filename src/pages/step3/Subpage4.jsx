    ...
    <div className="glass-panel" style={{ padding: '2rem' }}>
      ...
      <div className="glass-panel" style={{ padding: '1.5rem', borderLeft: '4px solid var(--success)', marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: '1.8' }}>
          ...
          این نتیجه نشان می‌دهد که در توابع عرضه خطی نهاده، <strong>شیب منحنی MFC دقیقاً دو برابر شیب منحنی عرضه نهاده است</strong> (مانند رابطه MR و تقاضا در انحصار فروش).
        </p>
      </div>
      ...
      <p style={{ color: "var(--text-muted)", lineHeight: "1.8", marginBottom: "2rem" }}>
        در این حالت به دلیل اینکه <InlineMath math="MR < P" /> است، همواره داریم <InlineMath math="MRP_x < VMP_x" />. این نابرابری ثابت می‌کند که در وضعیت انحصار مضاعف، <strong>میزان استخدام عوامل تولید به شدت کاهش یافته و دستمزد پرداختی به عوامل تولید به مراتب پایین‌تر از حالت مونوپسونی عادی است</strong> (استثمار شدید عوامل تولید).
      </p>
