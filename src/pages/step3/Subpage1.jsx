      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
        <div className="glass-panel" style={{ padding: '1.5rem', borderTop: '3px solid var(--danger)' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: '1.8' }}>
            مثبت محصولات کشاورزی. عرضه امسال بر اساس قیمت سال گذشته شکل می‌گیرد، اما تقاضا به قیمت امسال بستگی دارد.
          </p>
        ...
        <div className="glass-panel" style={{ padding: '1.5rem', borderTop: '3px solid var(--success)' }}>
          <h4 style={{ color: 'var(--success)', marginBottom: '0.5rem' }}>ب) تعادل پویا پیوسته (بدون وقفه)</h4>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: '1.8' }}>
            سرعت تغییر قیمت، متناسب با میزان مازاد تقاضا در همان لحظه است (معادلات دیفرانسیل):
          </p>
          <BlockMath math="\frac{dP}{dt} = k \cdot E(P_t) = k(D_t - S_t)" />
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: '1.8', marginTop: '0.5rem' }}>
            با استفاده از عامل انتگرال‌ساز، جواب معادله دیفرانسیل (مسیر قیمت) به دست می‌آید:
          </p>
          <BlockMath math="P_t = P_e + (P_0 - P_e) \cdot e^{k(a-A)t}" />
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', lineHeight: '1.8', marginTop: '0.5rem' }}>
            زمانی که <InlineMath math="t \to \infty" />، اگر <InlineMath math="(a-A) < 0" /> باشد، قیمت به تعادل <InlineMath math="P_e" /> همگرا می‌شود.
          </p>
        </div>
      </div>
