    ...
    <div className="glass-panel" style={{ padding: '2rem' }}>
      ...
      <div className="glass-panel" style={{ padding: '1rem', background: 'rgba(59, 130, 246, 0.03)', borderRight: '4px solid var(--primary)', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: '1.8', margin: 0 }}>
          یکی از بهترین مثال‌ها، رابطه بین <strong>اتحادیه‌های کارگری قدرتمند (تنها فروشنده نیروی کار)</strong> و <strong>یک هلدینگ صنعتی بزرگ (تنها خریدار نیروی کار در منطقه)</strong> است. قیمت کار (دستمزد) در اینجا نه با قوانین عرضه و تقاضای رقابتی، بلکه بر اساس قراردادهای جمعی ناشی از چانه‌زنی و اعتصابات احتمالی طرفین تعیین می‌شود.
        </p>
      </div>
