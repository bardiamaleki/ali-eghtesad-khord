...
const Subpage3 = () => {
  return (
    <div className="glass-panel" style={{ padding: '2rem' }}>
      ...
      <p style={{ color: "var(--text-muted)", lineHeight: "1.8", marginBottom: "1rem" }}>
        این نظریه که توسط پل سویزی مطرح شد، پدیده <strong>چسبندگی قیمت‌ها <span style={{ whiteSpace: 'nowrap' }}>(Price Rigidity)</span></strong> در بازار انحصار چندجانبه را توصیف می‌کند. اساس این مدل بر فرضی نامتقارن استوار است:
        <br />
        - اگر بنگاهی قیمت خود را <strong>افزایش</strong> دهد، هیچ‌یک از رقبا از او پیروی نمی‌کنند (بخش تقاضای باکشش و صوری dd).
        <br />
        - اگر بنگاهی قیمت خود را <strong>کاهش</strong> دهد، تمام رقبا برای حفظ مشتریان از او پیروی می‌کنند (بخش تقاضای کم‌کشش و واقعی DD).
        <br />
        این تفاوت رفتار باعث ایجاد یک <strong>شکستگی <span style={{ whiteSpace: 'nowrap' }}>(Kink)</span></strong> در منحنی تقاضا و در نتیجه یک <strong>شکاف عمودی <span style={{ whiteSpace: 'nowrap' }}>(vertical gap)</span></strong> در منحنی درآمد نهایی (MR) می‌شود.
      </p>
