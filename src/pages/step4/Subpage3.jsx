...
import { PieChart, Sliders, TrendingDown, HelpCircle, Lightbulb } from 'lucide-react';
    ...
    <div className="glass-panel" style={{ padding: '2rem' }}>
      ...
      <div className="glass-panel" style={{ padding: '1rem', background: 'rgba(59, 130, 246, 0.03)', borderRight: '4px solid var(--primary)', marginBottom: '2rem' }}>
        <h4 style={{ color: 'var(--primary)', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
          <Lightbulb size={18} />
          چرا قیمت‌ها در الیگوپولی چسبنده هستند؟ (شهود مدل سویزی):
        </h4>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', lineHeight: '1.8', margin: 0 }}>
          پل سویزی مطرح کرد که رفتار رقبا در برابر تغییر قیمت انحصارگران نامتقارن است: اگر قیمت خود را <strong>بالا</strong> ببرید، کسی از شما پیروی نمی‌کند تا مشتریانتان را جذب کند. اما اگر قیمت را <strong>کاهش</strong> دهید، رقبا فوراً قیمت‌های خود را کاهش می‌دهند تا مشتریانشان را از دست ندهند. این عدم تقارن، منجر به ایجاد یک شکستگی (Kink) در تقاضا و یک شکاف عمودی در درآمد نهایی (MR) می‌شود که مانع تغییر قیمت به ازای نوسانات محدود هزینه‌ای می‌گردد.
        </p>
      </div>

      <p style={{ color: "var(--text-muted)", lineHeight: "1.8", marginBottom: "1rem" }}>
        این تفاوت رفتار باعث ایجاد یک <strong>شکستگی (Kink)</strong> در منحنی تقاضا و در نتیجه یک <strong>شکاف عمودی (Vertical Gap)</strong> در منحنی درآمد نهایی (MR) می‌شود.
      </p>
      ...
      <div style={{ textAlign: 'center', margin: '2rem 0', background: 'rgba(255,255,255,0.02)', padding: '1.5rem', borderRadius: '12px' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '1rem' }}>
          شکستگی در نقطه تعادل قیمت و ایجاد فاصله قطع‌شدگی در منحنی درآمد نهایی (MR).
        </p>
      </div>
      ...
      <div className="example-box" style={{ marginTop: '2rem' }}>
        ...
        <ol style={{ paddingRight: '1.5rem', color: 'var(--text-muted)', lineHeight: '2' }}>
          <li>
            <strong>گام ۱. محاسبه تعادل اولیه کورنو:</strong>
            <br />
            ...
            <BlockMath math="q_1^* = 10 \quad , \quad q_2^* = 10 \implies P_1^* = 70 \quad , \quad P_2^* = 55" />
            بنابراین شکستگی برای بنگاه اول در نقطه <InlineMath math="q_1 = 10" /> و <InlineMath math="P_1 = 70" /> رخ می‌دهد.
          </li>
          <li>
            <strong>گام ۲. تحلیل رفتار در قیمت‌های بالاتر از ۷۰ (عدم پیروی رقبا):</strong>
            <br />
            اگر بنگاه ۱ قیمت را افزایش دهد، بنگاه ۲ قیمت خود را در همان سطح قبلی <InlineMath math="P_2 = 55" /> حفظ می‌کند:
            <BlockMath math="55 = 95 - q_1 - 3q_2 \implies q_2 = \frac{40 - q_1}{3}" />
            با جایگذاری در تقاضای بنگاه ۱، تقاضای بخش بالایی (باکشش) حاصل می‌شود:
            <BlockMath math="P_1 = 100 - 2q_1 - \left( \frac{40 - q_1}{3} \right) = \frac{260 - 5q_1}{3}" />
            درآمد نهایی برای این بخش در نقطه مرز:
            <BlockMath math="MR_1^{upper} = \frac{260 - 10q_1}{3} \quad \xrightarrow{q_1=10} \quad MR_1^{upper} = 53.33" />
          </li>
          <li>
            <strong>گام ۳. تحلیل رفتار در قیمت‌های کمتر از ۷۰ (پیروی رقبا):</strong>
            <br />
            اگر بنگاه ۱ قیمت را کاهش دهد، بنگاه ۲ نیز قیمت خود را کم می‌کند تا مشتری از دست نرود. با فرض تطابق کامل رفتار (<InlineMath math="q_2 = q_1" />)، تقاضای بخش پایینی (کم‌کشش) عبارت است از:
            <BlockMath math="P_1 = 100 - 2q_1 - q_1 = 100 - 3q_1" />
            درآمد نهایی برای این بخش در نقطه مرز:
            <BlockMath math="MR_1^{lower} = 100 - 6q_1 \quad \xrightarrow{q_1=10} \quad MR_1^{lower} = 40" />
          </li>
          <li>
            <strong>گام ۴. تعیین محدوده چسبندگی قیمت:</strong>
            <br />
